...
or die("Product deleted");

list($picture)=mysqli_fetch_array($result);
$path="../product_image/$picture";
...
{}
/*this is delet query*/
mysqli_query($con,"delete from products where product_id='$product_id'")or die("Product Deleted");
} 
...
<body>
  <?php include("include/header.php");?>
	...
	<h1> Page <?php echo $page;?></h1></div><br>
